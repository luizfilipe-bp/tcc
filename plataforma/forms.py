...
class PerguntaForm(forms.Form):
    ...
    alternativa1 = forms.CharField(max_length=100, label="Alternativa 1")
    alternativa2 = forms.CharField(max_length=100, label="Alternativa 2")
    alternativa3 = forms.CharField(max_length=100, label="Alternativa 3")
    alternativa4 = forms.CharField(max_length=100, label="Alternativa 4")
    ...
    resposta = forms.BooleanField(label="Resposta (Verdadeiro/Falso)")
